 ...
 *
 * Two things in this system write mail without being agents: the router, when
 * it refuses an undeliverable message, and the ledger endpoint, when it accepts
 * or refuses a proposal. Until M3 the router-authored refusal claimed
...
export const RESERVED_AGENT_IDS: readonly string[] = [HERMES_SENDER, LEDGER_ENDPOINT]
